This is Single Page Application using React Router. There are three tab which allows the users to navigate. The three tab are Home,skill and Contact. 
The Screenshot is in the master branch. 
Please run the application by first cloning it on your desktop and follow the steps
1. cd to the project folder
2. npm start

If there any questions, feel free to send me an email.
